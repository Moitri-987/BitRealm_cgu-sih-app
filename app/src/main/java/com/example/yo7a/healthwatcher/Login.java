...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ed7 = findViewById(R.id.repassword);
        ed8 = findViewById(R.id.editTextTextEmailAddress);
        ed3 = findViewById(R.id.spinner);
        ed4 = findViewById(R.id.email);
        GenderSpin = findViewById(R.id.spinner2);
        ...
        Log.setOnClickListener(v -> {
            ...
            ageStr = ed3.getText().toString();
            nameStr = ed4.getText().toString();
